...
Pipeline de dados que coleta com Webscrap em selenium, transforma e modela informações operacionais de um porto (manobras previstas, navios atracados, fundeados e realizados), gerando snapshots a cada 4 horas para análise de previsão vs realizado.
